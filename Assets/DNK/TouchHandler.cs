...
public class TouchHandler : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (touchCount < 2)
        {
            ...
            //{
            //    Vector2 rayStart = new Vector2(Input.mousePosition.x, Input.mousePosition.y);

            //    if (touchCount > 0)
            //    {
            //        var touch = Input.GetTouch(0);

            //        rayStart = new Vector2(touch.position.x, touch.position.y);
            //    }

            //    var ray = Camera.main.ScreenPointToRay(rayStart);
                
            //    Plane objectPlane = new Plane(m_AugmentationObject.transform.up, m_AugmentationObject.transform.position);

            //    float hitDistance = 0f;

            //    if ( objectPlane.Raycast(ray, out hitDistance))
            //    {
            //        var newPos = ray.origin + ray.direction * hitDistance;
            //        //if ((newPos - m_AugmentationObject.transform.position).sqrMagnitude > 0.1f)
            //        //{
            //            m_AugmentationObject.transform.position = ray.origin + ray.direction * hitDistance;
            //        //}
            //    }
            //}
        }
